...
**شرح مختصر:**
توضح هذه الوثيقة كيف يتم اختبار النظام لضمان تحقيق جميع المتطلبات الوظيفية وغير الوظيفية.

**Summary:**
This document explains how the system is tested to ensure all functional and non-functional requirements are met.
...
## استراتيجية الاختبار (رسم توضيحي)
