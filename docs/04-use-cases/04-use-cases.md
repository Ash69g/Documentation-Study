...
| رمز | الممثل / Actor                   | المسؤوليات الأساسية / Core Responsibilities                                       | الفائدة المتوقعة / Value Delivered            |
| --- | -------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------- |
| 👤  | العميل النهائي / Customer        | - إنشاء الطلبات وتقديم روابط المنتجات<br>- تتبع حالة الطلب واستلام الإشعارات      | تجربة شفافة، ثقة في التسعير، زمن استجابة أسرع |
| 🛠️  | المشغل / Operations Specialist   | - تدقيق الطلبات وتأكيد الجدوى<br>- تنسيق التوريد والشحن والمحطات الوسيطة          | رؤية موحدة للحالة وتقليل الأخطاء التشغيلية    |
| 🤝  | المورد الخارجي / External Vendor | - توفير الأسعار وتأكيد التوفر<br>- تحديث أوقات التسليم واستلام الدفعات            | تدفق معلومات واضح ومدفوعات موثقة              |
| 💳  | فريق المالية / Finance Team      | - إصدار الفواتير وتتبع المدفوعات<br>- تسوية الحسابات وإعداد التقارير              | بيانات دقيقة وإجراءات موحدة وتقارير موثوقة    |
| 🎧  | فريق الدعم / Support Team        | - استقبال شكاوى العملاء والتحديثات العاجلة<br>- إعادة توجيه الطلبات للفرق المختصة | مستويات خدمة متوقعة وقاعدة معرفة متجددة       |

> ✅ **ملاحظة:** تم ربط المسؤوليات مباشرة بمؤشرات الأداء لضمان جاهزية التنفيذ.
