...
**👥 شرح مختصر:**
جدول يوضح الفاعلين الرئيسيين ودورهم وفائدتهم في النظام.

**👥 Summary:**
A table showing main actors, their roles, and their value in the system.
...
| 🖥️ المسؤول التقني    | Tech Admin          | مسؤول عن الصلاحيات والأمان والتكاملات               | Oversees permissions, security, and integrations             | يعين الأدوار، يراقب الأداء، ويطبق السياسات  | Assigns roles, monitors performance, enforces policies            | يحافظ على سلامة البيانات واستمرارية الخدمة | Maintains data safety and service continuity             |
...
**📄 شرح مختصر:**
جدول يوضح الحالات الأساسية، المسارات الرئيسية، والبديلة.

**📄 Summary:**
A table showing core use cases, main and alternate flows.
...
**📝 شرح مختصر:**
تفاصيل حالة تقديم طلب جديد، خطوات التنفيذ والمسارات الاستثنائية.

**📝 Summary:**
Details of the new order use case, execution steps and exception flows.
...
**🔗 شرح مختصر:**
جدول يربط المتطلبات بحالات الاستخدام لضمان التغطية.

**🔗 Summary:**
A table linking requirements to use cases for coverage assurance.
...
**🎬 شرح مختصر:**
مخطط تسلسلي يوضح تفاعل الأطراف في سيناريو الطلب.

**🎬 Summary:**
A sequence diagram showing party interactions in the order scenario.
...
sequenceDiagram
  ...
  participant ⚙️ Operator as مشغل العمليات
  participant 💰 Finance as المالية
  👤 Customer->>🎧 Service: طلب جديد بروابط متعددة
  🎧 Service->>👤 Customer: تقدير التكلفة وموافقة
  🎧 Service->>⚙️ Operator: إنشاء أمر شراء وشحنات
  ⚙️ Operator->>💰 Finance: تحديث حالة الشحن وإشعار الدفع
  💰 Finance->>👤 Customer: تأكيد استلام الدفعة
  ⚙️ Operator->>👤 Customer: تأكيد التسليم بالأدلة
```
...
**🚀 شرح مختصر:**
أفكار لتوسعة حالات الاستخدام مستقبلاً.

**🚀 Summary:**
Ideas for future use case extensions.
...
**📅 شرح مختصر:**
سياسات مراجعة وتحديث حالات الاستخدام لضمان الجودة.

**📅 Summary:**
Policies for reviewing and updating use cases to ensure quality.
